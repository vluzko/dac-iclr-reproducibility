...
from adversary import Discriminator
from TD3 import TD3
...
def store_results(evaluations, number_of_timesteps, loss_aggregate, loss_function):
    ...
    timestamp = time.time()
    results_fname = 'DAC_{}_{}_tsteps_{}_loss_{}_agg_{}_results.csv'.format(args.env_id, number_of_timesteps,
                                                                            loss_function, loss_aggregate, timestamp)
